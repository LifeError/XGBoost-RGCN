...
def setup_logging():
    ...
    logging.basicConfig(
        ...
        handlers=[
            ...
            logging.FileHandler('Test(RGCN)_logging_new_results.txt')  # 文件输出
        ]
    )
...
for epoch in range(num_epochs):
    ...
    if epoch % test_epochs == 0:
        metrics = evaluate_model(idx_test, labels, model, features, edge_index, edge_type, batch_size, device,threshold)
        logging.info(
